...
description: Learn how to create and push entities to Hydra in TypeScript, Python, and Go
---
...
Creating entities in Hydra involves:
1. Defining entity objects with components
2. Connecting to the Hydra gRPC service
...
Here's a complete example showing how to create several entities and push them to Hydra:
...
Hydra automatically expires entities when their `until` time is reached.
