...
description: Learn about Hydra's Entity Component System and how entities work
---
...
Instead of defining strict types like "Sensor" or "Detection", Hydra uses a compositional approach:
